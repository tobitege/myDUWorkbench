...
public sealed class WorkbenchSettingsService
{
    ...
    public WorkbenchSettings Load()
    {
        try
        {
            ...
            return new WorkbenchSettings
            {
                ...
                NqUtilsDllPathInput = persisted.NqUtilsDllPathInput,
                BlueprintImportEndpointInput = persisted.BlueprintImportEndpointInput,
                ...
                BlueprintImportAppendDateIfExists = persisted.BlueprintImportAppendDateIfExists,
                ...
                SelectedConstructSuggestionKind = persisted.SelectedConstructSuggestionKind,
                IncludeBlueprintOnlySuggestions = persisted.IncludeBlueprintOnlySuggestions,
    ...
    private static PersistedWorkbenchSettings BuildPersistedSettings(WorkbenchSettings settings)
    {
        return new PersistedWorkbenchSettings
        {
            ...
            SelectedConstructSuggestionKind = settings.SelectedConstructSuggestionKind,
